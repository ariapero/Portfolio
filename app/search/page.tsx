          ...
          <Card className="mt-8 bg-white/10 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap justify-center gap-4 text-lg font-medium font-zen">
                ...
                <Link href="/docs/resume.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-white text-teal-900 rounded hover:bg-gray-100 transition-colors">Resume</Link>
